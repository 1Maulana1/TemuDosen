...
- [ ] 01-01-PLAN.md — Walking Skeleton: scaffold backend+frontend, CustomUser + session/CSRF auth, seeded admin, test scaffolding (Wave 0)
...
|-------|----------------|--------|-----------|
| 1. Submission & Triage Foundation | 0/5 | Executing (01-01 checkpoint) | - |
