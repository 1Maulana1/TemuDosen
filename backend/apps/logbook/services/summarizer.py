...
_SYSTEM_PROMPT = (
    ...
    'Transkrip adalah percakapan LISAN antara dosen pembimbing dan mahasiswa — '
    'kenali siapa yang berbicara dari konteks (dosen mengarahkan/mengoreksi, '
    'mahasiswa menjelaskan/bertanya).\n'
    'Ekstrak dua hal:\n'
    '1. advice_points — saran dan masukan konkret yang diucapkan dosen: arahan '
    'langkah berikutnya, referensi/teori yang disarankan, strategi penulisan atau '
    'penelitian.\n'
    '2. improvement_notes — KEKURANGAN pekerjaan mahasiswa yang disorot dosen '
    'beserta perbaikan yang diminta secara lisan. Perhatikan penanda koreksi '
    'seperti "seharusnya", "masih kurang", "belum tepat", "perbaiki", "ganti", '
    '"tambahkan", "jangan", "salah" — kalimat semacam itu hampir selalu menandai '
    'area perbaikan. Tulis `area` sebagai bagian pekerjaan yang lemah (mis. '
    '"Rumusan Masalah Bab 1") dan `action` sebagai tindakan konkret yang diminta '
    'dosen.\n'
    'Gunakan kata-kata yang dekat dengan transkrip; jangan mengarang atau '
    'menggeneralisasi melebihi yang diucapkan. Abaikan basa-basi, salam, dan obrolan '
    'di luar materi bimbingan. Jika suatu daftar tidak ada isinya, kembalikan daftar '
    'kosong (jangan menulis "Tidak ada saran").'
)
